...
- GitHub YOLO organisation scoped to this repository PAT (requires yearly regeneration). Is used in AWS Lambda as secret. Good canditate in future to have automated token rotation set up.
